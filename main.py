    ...
    try:
        ...
        while run:
            ...
            if Menu == "title":
                ...
                Texte(f"Appuyez sur {key}", ("Arial black", 50, True, False), (0, 0, 0), width / 2, height - 64).draw(
                    window)
            ...
            if not Play:
                ...
                if Menu == "main":
                    ...
                    if focusedbutton == 2:
                        ...
                        if convert_inputs(controls[0], joysticks, 0)[6] and not confirm:
                            ...
                            confirm = True
                    Bouton.draw(window)
                    Texte("Pandaball", ("arial", 45, True, False), (0, 0, 0), width / 2, 3 * height / 4 - 20).draw(
                        window)
                    Texte("(Entraînement)", ("arial", 30, True, False), (0, 0, 0), width / 2, 3 * height / 4 + 20).draw(
                        window)
                ...
                if Menu == "commands":
                    ...
                    if commandconfig is None:
                        ...
                        for i, n in enumerate(commands):
                            ...
                            if n not in ["Default", "Menu", "DefaultKeyboard"]:
                                Bouton = Button(n, ("arial", 24, False, False), "./DATA/Images/Menu/Button.png",
                                                width / 2, (i + 1) * 60 - 180, 120, 50)
                        ...
                        # Ajout d'un profil
                        Bouton = Button("+", ("arial", 50, True, False), "./DATA/Images/Menu/Button.png", 100, 800, 50,
                                        50)
                        if focusedbutton == -2:
                            Bouton.changeImage("./DATA/Images/Menu/Button_focused.png")
                            if convert_inputs(controls[0], joysticks, 0)[6] and not confirm:
                        ...
                        # Retour
                        Bouton = Button("<--", ("arial", 50, True, False), "./DATA/Images/Menu/Button.png", 100, 850,
                                        100, 60)
                        if focusedbutton == -1:
                            Bouton.changeImage("./DATA/Images/Menu/Button_focused.png")
                            if convert_inputs(controls[0], joysticks, 0)[6] and not confirm:
                    ...
                    #### Création d'un nouveau profil
                        ...
                        name = Entry.get_text()
                        Texte("Enter name :  " + Entry.get_text(), ("arial", 30, False, False), (0, 0, 0), width / 2,
                              height / 2).draw(window)
                        Texte("<A/Enter to confirm>", ("arial", 30, False, False), (0, 0, 0), width / 2,
                    ...
                    #### Modification d'un profil
                        ...
                        for i, k in enumerate(commands[commandconfig][4:9]):
                            draw_input(window, 2 * width / 6, (i + 1) * 80, i + 4, k, inputget, i, focusedbutton, row,
                                       1)
                        ...
                        for i, k in enumerate(commands[commandconfig][9:13]):
                            draw_input(window, 4 * width / 6, (i + 1) * 80, i + 9, k, inputget, i, focusedbutton, row,
                                       2)
                        ...
                        for i, k in enumerate(commands[commandconfig][13:]):
                            draw_input(window, 5 * width / 6, (i + 1) * 80, i + 13, k, inputget, i, focusedbutton, row,
                                       3)
                            if focusedbutton == i and row == 3:
                                if convert_inputs(controls[0], joysticks, 0)[6] and not confirm:
                                    ...
                                    confirm = True
                        # Sauvegarde
                        Bouton = Button("Sauvegarder", ("arial", 50, True, False), "./DATA/Images/Menu/Button.png", 200,
                                        850, 250, 60)
                        ...
                        # Suppression
                        Bouton = Button("Supprimer", ("arial", 50, True, False), "./DATA/Images/Menu/Button.png", 1450,
                                        850, 200, 60)
                ...
                if Menu == "stage":
                    ...
                    if focusedbutton == -1:
                        ...
                        Texte(actualstages[focusedbutton], ("arial", 50, True, False), (0, 0, 0), 30, height // 2,
                    ...
                    for i in range(len(actualstages)):
                        Bouton = Button("", ("arial", 50, True, False), "./DATA/Images/Menu/Button.png",
                                        ((i % 9) * 150) + 250, (i // 9 * 150) + 100, 100, 100)
                        if focusedbutton == i:
                            Bouton.changeImage("./DATA/Images/Menu/Button_focused.png")
                        ...
                        window.blit(pygame.transform.scale(
                            pygame.image.load(f"./DATA/Images/Stages/{actualstages[i]}/{actualstages[i]}.png"),
                            (90, 90)), ((i % 9 * 150) + 205, (i // 9 * 150) + 55))
                ...
                if Menu == "char":
                    # retour
                    Bouton = Button("", ("arial", 30, True, False), "./DATA/Images/Menu/Button.png", width / 2, 40, 100,
                                    60)
                    ...
                    for i in range(len(chars)):
                        ...
                        Bouton = Button("", ("arial", 50, True, False), standard, 0,
                                        105 * (i - scroll1 - len(chars) + 4), 384, 100)
                        Bouton.draw(window)
                        Bouton = Button("", ("arial", 50, True, False), standard, 0,
                                        105 * (i - scroll1 + len(chars) + 4), 384, 100)
                        Bouton.draw(window)
                    ...
                    if training:
                        ...
                        Bouton.draw(window)
                        window.blit(pygame.transform.scale(
                            pygame.image.load("./DATA/Images/Sprites/Misc/Training/Training_icon.png"), (64, 64)),
                            (width - 128, height / 2 - 32))
                    else:
                        for i in range(len(chars)):
                            # Roulette
                            Bouton = Button("", ("arial", 50, True, False), standard, width,
                                            105 * (i - scroll2 - len(chars) + 4), 384, 100)
                            Bouton.draw(window)
                            Bouton = Button("", ("arial", 50, True, False), standard, width,
                                            105 * (i - scroll2 + len(chars) + 4), 384, 100)
                            Bouton.draw(window)
                            Bouton = Button("", ("arial", 50, True, False), standard, width, 105 * (i - scroll2 + 4),
                                            384, 100)
                            if selectchar_2 == i:
                                Bouton.changeImage("./DATA/Images/Menu/Button_focused.png")
                                Bouton.resize(400, 100)
                    ...
                    Bouton = Button(text, ("arial", 24, True, False), "./DATA/Images/Menu/Button.png", 3 * width / 10,
                                    height - 150, 200, 32)
                    Bouton.draw(window)
                    ...
                    Bouton = Button(text, ("arial", 24, True, False), "./DATA/Images/Menu/Button.png", 7 * width / 10,
                                    height - 150, 200, 32)
                    Bouton.draw(window)
                    # Test de compatibilité entre le nom et la manette
                    try:
                    ...
                    if selected_1:
                        ...
                        Texte("PRET", ("arial", 24, True, False), (0, 0, 0), width / 4, height - 110,
                              format_="center").draw(window)
                    if selected_2:
                        pygame.draw.rect(window, (230, 230, 230), (5 * width / 8, height - 120, width / 4, 30))
                        Texte("PRET", ("arial", 24, True, False), (0, 0, 0), 3 * width / 4, height - 110,
                              format_="center").draw(window)

                    ## Affichage des noms
                    pygame.draw.rect(window, (200, 200, 200), (0, height - 90, width, 90))
                    Texte(str(Chars.charobjects[chars[selectchar_1]](0, 0, 0)), ("arial", 64, True, False), (0, 0, 0),
                          width / 2 - 30, height - 50, format_="right").draw(window)
                    if training:
                        Texte("Pandapluche", ("arial", 64, True, False), (0, 0, 0), width / 2 + 30, height - 50,
                              format_="left").draw(window)
                    else:
                        Texte(str(Chars.charobjects[chars[selectchar_2]](0, 0, 0)), ("arial", 64, True, False),
                              (0, 0, 0), width / 2 + 30, height - 50, format_="left").draw(window)
                    Texte("|", ("arial", 80, True, False), (0, 0, 0), width / 2, height - 50, format_="center").draw(
                        window)
                    ##
                    ...
                    if (selected_2 or training) and selected_1:
                        ...
                        background = pygame.transform.scale(
                            pygame.image.load(f"./DATA/Images/Stages/{actualstages[stage]}/{actualstages[stage]}.png"),
                            (1600, 900))
                        for m in musics:
                            if m[1] == actualstages[stage] and (
                                    str(Char_P1) == m[2] or str(Char_P2) == m[2] or m[2] == True):
                                currentmusic = m[0]
                        musicplaying = False
                        # création du stage
            ...
            ############################################  En  combat  ############################################
                ...
                Texte(f"{str(round(Char_P1.damages, 2)).split('.')[0]}  %", ("Arial", 60, False, False),
                      (255 - (Char_P1.damages / 5), max(255 - Char_P1.damages, 0), max(255 - Char_P1.damages * 2, 0)),
                      width // 3, height - 50, 800, format_="left").draw(window)
                Texte(f".{str(round(Char_P1.damages, 2)).split('.')[1]}", ("Arial", 30, False, False),
                      (255 - (Char_P1.damages / 5), max(255 - Char_P1.damages, 0), max(255 - Char_P1.damages * 2, 0)),
                      width // 3 + len(str(round(Char_P1.damages, 2)).split('.')[0]) * 25, height - 30, 800,
                      format_="left").draw(window)

                Char_P2.damages = float(Char_P2.damages)
                Texte(f"{str(round(Char_P2.damages, 2)).split('.')[0]}  %", ("Arial", 60, False, False),
                      (255 - (Char_P2.damages / 5), max(255 - Char_P2.damages, 0), max(255 - Char_P2.damages * 2, 0)),
                      2 * width // 3, height - 50, 800, format_="left").draw(window)
                Texte(f".{str(round(Char_P2.damages, 2)).split('.')[1]}", ("Arial", 30, False, False),
                      (255 - (Char_P2.damages / 5), max(255 - Char_P2.damages, 0), max(255 - Char_P2.damages * 2, 0)),
                      2 * width // 3 + len(str(round(Char_P2.damages, 2)).split('.')[0]) * 25, height - 30, 800,
                      format_="left").draw(window)
                ...
                if not training:
                    for s in range(stock[0] // 5 + 1):  # colonnes de 5 icones à côté des dégâts
                        for k in range(min(stock[0] - 5 * s, 5)):
                            window.blit(pygame.transform.scale(icons[Char_P1.name], (16, 16)),
                                        (width / 3 - 25 - 20 * s, height - 40 - 20 * k))

                    for s in range(stock[1] // 5 + 1):
                        for k in range(min(stock[1] - 5 * s, 5)):
                            window.blit(pygame.transform.scale(icons[Char_P2.name], (16, 16)),
                ...
                if not training:
                    ...
                    if m * 60 + s > 0 and game_running < 0:
                        if m * 60 + s > 5:
                            Texte(f"{str(m)}:{str(s)}'{str(ms)}", ("Arial", 60, True, False), (255, 255, 255),
                                  width / 2, 75).draw(window)
                        else:
                            Texte(f"{str(s)}", ("Arial", 180, True, False), (100, 0, 0), width / 2, height / 2).draw(
                                window)
                    ...
                    if (m * 60 + s < 1 or min(stock) <= 0) and game_running < 0:
                        ...
                        pygame.mixer.music.stop()
                    if game_running > 0:
                        Texte("FIN DU MATCH", ("Arial", 200, True, False), (150, 0, 0), width / 2, height / 2).draw(
                            window)
                        game_running -= 1
                        if game_running < 1:
                            Play = False
                ...
                if training:
                    ...
                    Texte(str(Char_P2.combo), ("Arial", 40, False, False), (0, 0, 0), width - 80, height / 2 + 25).draw(
                        window)
                    pygame.draw.rect(window, (250, 250, 250), (width - 120, height / 2 + 75, 120, 60))
                    Texte(str(round(Char_P2.combodamages, 2)) + "%", ("Arial", 40, False, False), (0, 0, 0), width - 80,
                    ...
                    if pause:
                        if training:
                            ...
                            # Quitter
                            Bouton = Button(f"Quitter", ("Arial", 20, False, False), "./DATA/Images/Menu/Button.png",
                                            150, height / 12, 200, 60)
                            if focusedbutton == -1:
                                Bouton.changeImage("./DATA/Images/Menu/Button_focused.png")
                                if convert_inputs(controls[0], joysticks, 0)[6] and not confirm:
                                    confirm = True
                            ...
                            Bouton = Button("Réinitialiser", ("Arial", 40, False, False),
                                            "./DATA/Images/Menu/Button.png", 150, 2.5 * height / 12, 200, 60)
                            if focusedbutton == 0:
                                Bouton.changeImage("./DATA/Images/Menu/Button_focused.png")
                                if convert_inputs(controls[0], joysticks, 0)[6] and not confirm:
                                    confirm = True
                            ...
                            Bouton = Button(f"DI Horizontale : {['Aucune', 'Droite', 'Gauche'][TrainingHDI]}",
                            ...
                            Bouton = Button(f"DI Verticale : {['Aucune', 'Haut', 'Bas'][TrainingVDI]}",
                                            ("Arial", 20, False, False), "./DATA/Images/Menu/Button.png", 150,
                            ...
                            Bouton = Button(f"Tech : {['Jamais', '1/2', 'Toujours'][Tech]}",
                                            ("Arial", 20, False, False), "./DATA/Images/Menu/Button.png", 150,
                                            5.5 * height / 12, 200, 60)
                            if focusedbutton == 3:
                                Bouton.changeImage("./DATA/Images/Menu/Button_focused.png")
                                if convert_inputs(controls[0], joysticks, 0)[6] and not confirm:
                                    confirm = True
                            ...
                            Texte(f"Dégâts : {round(basedamages)}%", ("Arial", 20, False, False), (0, 0, 0), 150,
                            ...
                            Bouton = Button(f"", ("Arial", 20, False, False), "./DATA/Images/Menu/Slider.png",
                                            basedamages / 999 * 200 + 60, 6.5 * height / 12, 12, 12)
                            if focusedbutton == 4:
                            ...
                            Texte(f"Decéleration : {round(deceleration, 2)}", ("Arial", 20, True, False), (0, 0, 0),
                                  150, 8 * height / 12 - 25).draw(window)
                            pygame.draw.rect(window, (10, 10, 10), (40, 8 * height / 12 + 3, 254, 4))
                            Bouton = Button(f"", ("Arial", 20, False, False), "./DATA/Images/Menu/Slider.png",
                                            (deceleration - 0.5) * 500 + 40, 8 * height / 12 + 5, 12, 12)
                            if focusedbutton == 5:
                            ...
                            for p in Chars.decelerations:
                                ...
                                if abs(deceleration - Chars.decelerations[p]) < 0.01 and (not (
                                        convert_inputs(controls[0], joysticks, 0)[1] or
                                        convert_inputs(controls[0], joysticks, 0)[0]) or focusedbutton != 5):
                            ...
                            if equal:
                                ...
                                for e in equal:
                                    txt += e + "/"
                                Texte(f"({txt[:-1]})", ("Arial", 15, False, False), (0, 0, 0), 150,
                                      8 * height / 12 - 10).draw(window)
                            Bouton.draw(window)

                            #### Vitesse aérienne 

                            Texte(f"Vitesse aérienne : {round(airspeed, 1)}", ("Arial", 20, True, False), (0, 0, 0),
                                  150, 9 * height / 12 - 25).draw(window)
                            pygame.draw.rect(window, (10, 10, 10), (40, 9 * height / 12 + 3, 254, 4))
                            Bouton = Button(f"", ("Arial", 20, False, False), "./DATA/Images/Menu/Slider.png",
                                            (airspeed - 0.5) / 1.5 * 250 + 40, 9 * height / 12 + 5, 12, 12)
                            if focusedbutton == 6:
                            ...
                            for p in Chars.airspeeds:
                                ...
                                if abs(airspeed - Chars.airspeeds[p]) < 0.03 and (not (
                                        convert_inputs(controls[0], joysticks, 0)[1] or
                                        convert_inputs(controls[0], joysticks, 0)[0]) or focusedbutton != 6):
                            ...
                            if equal:
                                ...
                                for e in equal:
                                    txt += e + "/"
                                Texte(f"({txt[:-1]})", ("Arial", 15, False, False), (0, 0, 0), 150,
                                      9 * height / 12 - 10).draw(window)
                            Bouton.draw(window)

                            #### Vitesse de chute 

                            Texte(f"Vitesse de chute : {round(fallspeed, 1)}", ("Arial", 20, True, False), (0, 0, 0),
                                  150, 10 * height / 12 - 25).draw(window)
                            pygame.draw.rect(window, (10, 10, 10), (40, 10 * height / 12 + 3, 254, 4))
                            Bouton = Button(f"", ("Arial", 20, False, False), "./DATA/Images/Menu/Slider.png",
                                            (fallspeed - 0.25) / 1.25 * 250 + 40, 10 * height / 12 + 5, 12, 12)
                            if focusedbutton == 7:
                            ...
                            for p in Chars.fallspeeds:
                                ...
                                if abs(fallspeed - Chars.fallspeeds[p]) < 0.03 and (not (
                                        convert_inputs(controls[0], joysticks, 0)[1] or
                                        convert_inputs(controls[0], joysticks, 0)[0]) or focusedbutton != 7):
                            ...
                            if equal:
                                ...
                                for e in equal:
                                    txt += e + "/"
                                Texte(f"({txt[:-1]})", ("Arial", 15, False, False), (0, 0, 0), 150,
                                      10 * height / 12 - 10).draw(window)
                            Bouton.draw(window)

                            #### Vitesse de fastfall 

                            Texte(f"Vitesse de Fastfall : {round(fastfallspeed, 1)}", ("Arial", 20, True, False),
                                  (0, 0, 0), 150, 11 * height / 12 - 25).draw(window)
                            pygame.draw.rect(window, (10, 10, 10), (40, 11 * height / 12 + 3, 254, 4))
                            Bouton = Button(f"", ("Arial", 20, False, False), "./DATA/Images/Menu/Slider.png",
                                            (fastfallspeed - 0.5) / 1.5 * 250 + 40, 11 * height / 12 + 5, 12, 12)
                            if focusedbutton == 8:
                                # Compris entre 0.5 et 2
                                Bouton.changeImage("./DATA/Images/Menu/Slider_focused.png")
                                if convert_inputs(controls[0], joysticks, 0)[1]:
                            ...
                            for p in Chars.fastfallspeeds:
                                ...
                                if abs(fastfallspeed - Chars.fastfallspeeds[p]) < 0.03 and (not (
                                        convert_inputs(controls[0], joysticks, 0)[1] or
                                        convert_inputs(controls[0], joysticks, 0)[0]) or focusedbutton != 8):
