...
class Pyro_Aubin(Char):
    ...
    def animation_attack(self,attack,inputs,stage,other):
        ...
        if attack == "DownB":
            if self.frame == 10:
                if self.explosifs > 6 :
                    ...
                    pygame.mixer.Sound("DATA/Musics/SFX/wooshs/mini woosh").play()
                    self.explosifs -= 6
        ...
        if attack == "DownTilt":
            if self.frame == 8 :
                self.active_hitboxes.append(Hitbox(48,80,48,48,-pi/3,10,6,1/200,8,17,self,sound="hits/cool hit"))
        ...
        if attack == "ForwardTilt":
            ...
            if self.frame == 8 :
                if self.explosifs > 5 :
                    self.explosifs -= 5
                    pygame.mixer.Sound("DATA/Musics/SFX/other/gun shot").play()
        ...
        if attack == "UpTilt":
            if self.frame == 8 :
                self.active_hitboxes.append(Hitbox(50,60,30,30,pi/2,15,4,1/300,12,4,self,deflect=True,modifier=0.5,sound="hits/punch2"))
        ...
        if attack == "ForwardSmash":
            ...
            if self.frame == 40 :
                ...
                if self.explosifs > 5:
                    ...
                    pygame.mixer.Sound("DATA/Musics/SFX/BOOM !!!/Cannon").play()
        ...
        if attack == "Superspecial":
            if self.frame == 8 :
                if self.explosifs > 49.5 :
                    ...
                    self.active_hitboxes.append(Hitbox(-140,-100,328,320,pi/4,35,120,1/100,40,10,self,True,sound="other/gun shot"))
                else :
                    self.konami = []
                    self.konamiadd = False
