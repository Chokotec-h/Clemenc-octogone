...
class Balan(Char):
    ...
    def animation_attack(self, attack, inputs, stage, other):
        ...
        if attack == "SideB":
            ...
            if 9 < self.frame < 60:  # Déplacement
        ...
        if attack == "Jab":
            ...
            if self.frame == 3:  # 1er hit frame 3-6
                pygame.mixer.Sound("DATA/Musics/SFX/plein de craie -_-/craie 1.mp3").play()
                self.active_hitboxes.append(Hitbox(40, 36, 48, 24, 3 * pi / 4, 2, 0.6, 0, 10, 4, self, True))
            if self.frame == 9:  # 2e hit frame 9-12
                pygame.mixer.Sound("DATA/Musics/SFX/plein de craie -_-/craie 2.mp3").play()
        ...
        if attack == "ForwardTilt":
            ...
            if self.frame == 14:  # 2e hit frame 14-22
                pygame.mixer.Sound("DATA/Musics/SFX/plein de craie -_-/craie 3.mp3").play()
        ...
        if attack == "DashAttack":
            ...
            if 21 > self.frame > 4 and self.frame % 5 == 0:  # active on 5/10/15/20
                self.active_hitboxes.append(
                    Hitbox(40, 32, 32, 32, pi / 12, abs(self.vx), 1.5, 0, 12, 2, self, False, boum=-1))
...
class Projo_Craie():
    def __init__(self, id, own, stage):
        # Craies de M Balan
        pygame.mixer.Sound("DATA/Musics/SFX/wooshs/mini woosh.wav").play()
        self.id = id + 1
