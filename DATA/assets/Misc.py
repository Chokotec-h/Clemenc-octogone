...
class Smoke():
    ...
    def draw(self,window):
        window.blit(smokesprite[self.duration//4-1],(resize(self.x+800,0,width,height)[0],resize(0,self.y+450,width,height)[1]))
        self.duration -= 1
...
class Dash_Smoke():
    ...
    def draw(self,window):
        ...
        pos = [resize(self.x + 800,0,width,height)[0] - size[2]/2, size[3] + resize(0,self.y+280,width,height)[1]] # Position réelle du sprite
