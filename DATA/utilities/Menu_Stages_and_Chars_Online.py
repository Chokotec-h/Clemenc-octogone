...
class CharsMenuOnline:
    ...
    def update(self, window, width, height, controls, joysticks, server):
        ...
        Bouton.draw(window)
        window.blit(icons64[chars[self.selectchar_2][self.otheralt]], (width - resize(64,0,width,height)[0] - resize(0,64,width,height)[1], height / 2 - resize(0,32,width,height)[1]))
